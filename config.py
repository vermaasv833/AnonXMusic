...
def get_env_variable(var_name, default=None, var_type=str):
    ...
    try:
        ...
        raise ValueError(f"Environment variable {var_name} must be of type {var_type.__name__}.")

# Get this value from my.telegram.org/apps
API_ID = get_env_variable("API_ID", var_type=int)
...
DURATION_LIMIT_MIN = get_env_variable("DURATION_LIMIT", 60, var_type=int)

# Chat id of a group for logging bot's activities
LOGGER_ID = get_env_variable("LOGGER_ID", None, var_type=int)

# Get this value from @FallenxBot on Telegram by /id
OWNER_ID = get_env_variable("OWNER_ID", 1356469075, var_type=int)
...
PLAYLIST_FETCH_LIMIT = get_env_variable("PLAYLIST_FETCH_LIMIT", 25, var_type=int)

# Telegram audio and video file size limit (in bytes)
TG_AUDIO_FILESIZE_LIMIT = get_env_variable("TG_AUDIO_FILESIZE_LIMIT", 104857600, var_type=int)
TG_VIDEO_FILESIZE_LIMIT = get_env_variable("TG_VIDEO_FILESIZE_LIMIT", 1073741824, var_type=int)
